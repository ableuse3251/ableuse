...
var formations: Dictionary = {
	...
	"4-3-3": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.18, "y": 0.72}, {"position": "DEF", "x": 0.39, "y": 0.76}, {"position": "DEF", "x": 0.61, "y": 0.76}, {"position": "DEF", "x": 0.82, "y": 0.72},
		{"position": "MID", "x": 0.30, "y": 0.55}, {"position": "MID", "x": 0.50, "y": 0.50}, {"position": "MID", "x": 0.70, "y": 0.55},
		{"position": "FWD", "x": 0.25, "y": 0.25}, {"position": "FWD", "x": 0.50, "y": 0.20}, {"position": "FWD", "x": 0.75, "y": 0.25}
	],
	"4-5-1": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.18, "y": 0.72}, {"position": "DEF", "x": 0.39, "y": 0.76}, {"position": "DEF", "x": 0.61, "y": 0.76}, {"position": "DEF", "x": 0.82, "y": 0.72},
		{"position": "MID", "x": 0.15, "y": 0.55}, {"position": "MID", "x": 0.35, "y": 0.50}, {"position": "MID", "x": 0.50, "y": 0.48}, {"position": "MID", "x": 0.65, "y": 0.50}, {"position": "MID", "x": 0.85, "y": 0.55},
		{"position": "FWD", "x": 0.50, "y": 0.22}
	],
	"3-5-2": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.30, "y": 0.78}, {"position": "DEF", "x": 0.50, "y": 0.80}, {"position": "DEF", "x": 0.70, "y": 0.78},
		{"position": "MID", "x": 0.15, "y": 0.55}, {"position": "MID", "x": 0.35, "y": 0.60}, {"position": "MID", "x": 0.50, "y": 0.50}, {"position": "MID", "x": 0.65, "y": 0.60}, {"position": "MID", "x": 0.85, "y": 0.55},
		{"position": "FWD", "x": 0.35, "y": 0.25}, {"position": "FWD", "x": 0.65, "y": 0.25}
	],
	"3-4-3": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.30, "y": 0.78}, {"position": "DEF", "x": 0.50, "y": 0.80}, {"position": "DEF", "x": 0.70, "y": 0.78},
		{"position": "MID", "x": 0.20, "y": 0.55}, {"position": "MID", "x": 0.40, "y": 0.50}, {"position": "MID", "x": 0.60, "y": 0.50}, {"position": "MID", "x": 0.80, "y": 0.55},
		{"position": "FWD", "x": 0.25, "y": 0.25}, {"position": "FWD", "x": 0.50, "y": 0.20}, {"position": "FWD", "x": 0.75, "y": 0.25}
	],
	"5-3-2": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.15, "y": 0.75}, {"position": "DEF", "x": 0.32, "y": 0.78}, {"position": "DEF", "x": 0.50, "y": 0.80}, {"position": "DEF", "x": 0.68, "y": 0.78}, {"position": "DEF", "x": 0.85, "y": 0.75},
		{"position": "MID", "x": 0.30, "y": 0.55}, {"position": "MID", "x": 0.50, "y": 0.50}, {"position": "MID", "x": 0.70, "y": 0.55},
		{"position": "FWD", "x": 0.35, "y": 0.25}, {"position": "FWD", "x": 0.65, "y": 0.25}
	],
	"5-4-1": [
	...
	"4-2-3-1": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.18, "y": 0.72}, {"position": "DEF", "x": 0.39, "y": 0.76}, {"position": "DEF", "x": 0.61, "y": 0.76}, {"position": "DEF", "x": 0.82, "y": 0.72},
		{"position": "MID", "x": 0.35, "y": 0.60}, {"position": "MID", "x": 0.65, "y": 0.60},
		{"position": "MID", "x": 0.25, "y": 0.40}, {"position": "MID", "x": 0.50, "y": 0.38}, {"position": "MID", "x": 0.75, "y": 0.40},
		{"position": "FWD", "x": 0.50, "y": 0.20}
	],
	"4-1-4-1": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.18, "y": 0.72}, {"position": "DEF", "x": 0.39, "y": 0.76}, {"position": "DEF", "x": 0.61, "y": 0.76}, {"position": "DEF", "x": 0.82, "y": 0.72},
		{"position": "MID", "x": 0.50, "y": 0.62},
		{"position": "MID", "x": 0.20, "y": 0.45}, {"position": "MID", "x": 0.40, "y": 0.42}, {"position": "MID", "x": 0.60, "y": 0.42}, {"position": "MID", "x": 0.80, "y": 0.45},
		{"position": "FWD", "x": 0.50, "y": 0.20}
	],
	"4-4-1-1": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.18, "y": 0.72}, {"position": "DEF", "x": 0.39, "y": 0.76}, {"position": "DEF", "x": 0.61, "y": 0.76}, {"position": "DEF", "x": 0.82, "y": 0.72},
		{"position": "MID", "x": 0.22, "y": 0.53}, {"position": "MID", "x": 0.40, "y": 0.50}, {"position": "MID", "x": 0.60, "y": 0.50}, {"position": "MID", "x": 0.78, "y": 0.53},
		{"position": "FWD", "x": 0.50, "y": 0.35},
		{"position": "FWD", "x": 0.50, "y": 0.20}
	],
	"3-4-2-1": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.30, "y": 0.78}, {"position": "DEF", "x": 0.50, "y": 0.80}, {"position": "DEF", "x": 0.70, "y": 0.78},
		{"position": "MID", "x": 0.20, "y": 0.58}, {"position": "MID", "x": 0.40, "y": 0.55}, {"position": "MID", "x": 0.60, "y": 0.55}, {"position": "MID", "x": 0.80, "y": 0.58},
		{"position": "FWD", "x": 0.35, "y": 0.35}, {"position": "FWD", "x": 0.65, "y": 0.35},
		{"position": "FWD", "x": 0.50, "y": 0.20}
	],
	"3-4-1-2": [
		{"position": "GK", "x": 0.50, "y": 0.90},
	...
	"4-2-2-2": [
		...
		{"position": "DEF", "x": 0.18, "y": 0.72}, {"position": "DEF", "x": 0.39, "y": 0.76}, {"position": "DEF", "x": 0.61, "y": 0.76}, {"position": "DEF", "x": 0.82, "y": 0.72},
		{"position": "MID", "x": 0.35, "y": 0.60}, {"position": "MID", "x": 0.65, "y": 0.60},
		{"position": "MID", "x": 0.30, "y": 0.42}, {"position": "MID", "x": 0.70, "y": 0.42},
		{"position": "FWD", "x": 0.35, "y": 0.22}, {"position": "FWD", "x": 0.65, "y": 0.22}
	],
	"4-1-3-2": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.18, "y": 0.72}, {"position": "DEF", "x": 0.39, "y": 0.76}, {"position": "DEF", "x": 0.61, "y": 0.76}, {"position": "DEF", "x": 0.82, "y": 0.72},
		{"position": "MID", "x": 0.50, "y": 0.62},
		{"position": "MID", "x": 0.25, "y": 0.45}, {"position": "MID", "x": 0.50, "y": 0.42}, {"position": "MID", "x": 0.75, "y": 0.45},
		{"position": "FWD", "x": 0.35, "y": 0.22}, {"position": "FWD", "x": 0.65, "y": 0.22}
	],
	"3-5-1-1": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.30, "y": 0.78}, {"position": "DEF", "x": 0.50, "y": 0.80}, {"position": "DEF", "x": 0.70, "y": 0.78},
		{"position": "MID", "x": 0.15, "y": 0.58}, {"position": "MID", "x": 0.35, "y": 0.60}, {"position": "MID", "x": 0.50, "y": 0.55}, {"position": "MID", "x": 0.65, "y": 0.60}, {"position": "MID", "x": 0.85, "y": 0.58},
		{"position": "MID", "x": 0.50, "y": 0.38},
		{"position": "FWD", "x": 0.50, "y": 0.20}
	],
	"5-2-3": [
		{"position": "GK", "x": 0.50, "y": 0.90},
		{"position": "DEF", "x": 0.15, "y": 0.75}, {"position": "DEF", "x": 0.32, "y": 0.78}, {"position": "DEF", "x": 0.50, "y": 0.80}, {"position": "DEF", "x": 0.68, "y": 0.78}, {"position": "DEF", "x": 0.85, "y": 0.75},
		{"position": "MID", "x": 0.35, "y": 0.55}, {"position": "MID", "x": 0.65, "y": 0.55},
		{"position": "FWD", "x": 0.25, "y": 0.25}, {"position": "FWD", "x": 0.50, "y": 0.20}, {"position": "FWD", "x": 0.75, "y": 0.25}
	],
	"4-3-2-1": [
		{"position": "GK", "x": 0.50, "y": 0.90},
...
func _build_ui() -> void:
	...
	# Всплывающее меню карточки (скрыто по умолчанию)
...
func _refresh_squad() -> void:
	...
	var raw_slots = formations.get(current_formation, formations["4-4-2"])
	...
	var lineup = ClubManager.get_starting_lineup()
...
func _create_field_card(card: PlayerCard, slot_index: int) -> void:
	...
	if card_node.has_signal("card_selected"):
...
func _get_slot_position(slot_index: int) -> Vector2:
	...
	var slot = formation_slots[slot_index]
	return Vector2(
...
func _show_card_popup(slot_index: int) -> void:
	...
	# Позиционируем popup рядом с карточкой
	var popup_x: float = slot_pos.x + 50
	var popup_y: float = slot_pos.y - 60
	
	# Не даём popup выйти за пределы экрана
...
func _refresh_substitutes() -> void:
	...
	var subs = ClubManager.get_substitutes()
	for card in subs:
		if card != null:
			var card_node = card_ui_scene.instantiate()
			card_node.z_index = 5
			subs_container.add_child(card_node)
			...
			if card_node.has_method("setup"):
				card_node.setup(card)
			if card_node.has_signal("card_selected"):
				card_node.card_selected.connect(func(_data): _on_sub_card_clicked(card))
...
func _on_field_card_clicked(slot_index: int) -> void:
	# Показываем popup с опциями "Заменить" и "Убрать"
...
func _open_player_selector(required_position: String, slot_index: int = -1) -> void:
	...
	var lineup = ClubManager.get_starting_lineup()
	var subs = ClubManager.get_substitutes()
	var all_club_cards = ClubManager.get_all_cards()
	...
	for card in available_players:
		var card_node = card_ui_scene.instantiate()
		selection_grid.add_child(card_node)
		if card_node.has_method("set_compact_mode"):
			card_node.set_compact_mode()
		if card_node.has_method("setup"):
			card_node.setup(card)
		if card_node.has_signal("card_selected"):
			if required_position == "SUBSTITUTE":
				card_node.card_selected.connect(func(_data): _on_player_selected_for_sub(card))
			else:
				card_node.card_selected.connect(func(_data): _on_player_selected_for_slot(card, slot_index))
