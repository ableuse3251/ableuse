class_name SquadCardPopupController
extends RefCounted

# ============================================================
# ПОПАП КАРТОЧКИ (КОМПОНЕНТ SQUADSCREEN)
# ============================================================
# Всплывающее меню игрока на поле: позиционирование попапа у
# слота, операции «Заменить» и «Убрать из состава».
# ============================================================
...
func show(slot_index: int) -> void:
	popup_slot_index = slot_index

	var slot_pos := screen.field_controller.get_slot_position(slot_index)
